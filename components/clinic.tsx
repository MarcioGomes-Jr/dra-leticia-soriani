        ...
        >
          <div className="text-center mb-16">
            ...
            <h2 className="font-serif text-3xl md:text-4xl lg:text-5xl font-medium text-foreground mb-4 text-balance">
              Conheça nossa clínica em Maringá
            </h2>
            <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
              Atendimento presencial e online para sua melhor comodidade.
            </p>
          </div>
                ...
                {clinicImages.map((image, index) => (
                  <button
                    ...
                    className={`relative rounded-lg overflow-hidden aspect-square bg-muted transition-all duration-300 ${selectedImage === index
                        ? "ring-2 ring-[#7A7566] ring-offset-2"
            ...
            <div>
              <div className="bg-card rounded-2xl p-6 md:p-8 border border-border">
                ...
                <div className="space-y-6">
                  <div className="flex gap-4 group">
                    <div className="w-12 h-12 bg-[#7A7566]/10 rounded-xl flex items-center justify-center shrink-0 group-hover:bg-[#7A7566] transition-all duration-300">
                      <MapPin className="text-[#7A7566] group-hover:text-white transition-colors" size={22} />
                    </div>
                    <div>
                ...
                <a
                  ...
                  className="group w-full mt-8 inline-flex items-center justify-center gap-2 px-8 py-4 bg-[#7A7566] text-white font-medium rounded-full hover:bg-[#a89e94] transition-all duration-300 hover:shadow-xl"
                >
                  Agende sua Consulta
              ...
              <div className="mt-6 rounded-xl overflow-hidden border border-border">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 p-3 bg-card hover:bg-[#7A7566]/10 transition-colors text-sm text-foreground"
                >
                  Abrir no Maps
